...
interface SourceResearchViewProps {
...
const SourceResearchView: React.FC<SourceResearchViewProps> = ({ result, error, onComplete, onNewSearch }) => {

  useEffect(() => {
    if (result || error) {
      const timer = setTimeout(() => {
        onComplete();
      }, 1200); // Small delay to show completion before navigating
    ...
    <div className="flex-grow flex flex-col justify-center items-center p-4 sm:p-6 lg:p-8 bg-white">
      <div className="text-center">
            ...
            <div className="flex items-center justify-center gap-3 text-gray-600">
                ...
                <p className="font-medium text-lg">Finding and summarizing sources...</p>
            </div>
        </div>
    </div>
  );
...
export default SourceResearchView;