...
export const UpArrowIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg
...
export const DiamondIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M14.25 6.087c0-.355-.186-.676-.401-.959a1.65 1.65 0 0 0-2.7 0c-.215.283-.401.604-.401.959c0 .355.186.676.401.959a1.65 1.65 0 0 0 2.7 0c.215-.283.401-.604.401-.959Zm0 0c.215-.283.401-.604.401-.959a1.65 1.65 0 0 0-2.7 0c-.215.283-.401.604-.401.959" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a8.25 8.25 0 0 0 6.285-2.822c.69-.921 1.342-2.028 1.342-3.335c0-2.95-2.462-5.962-7.627-5.962s-7.627 3.012-7.627 5.962c0 1.307.652 2.414 1.342 3.335A8.25 8.25 0 0 0 12 21Z" />
    </svg>
);

export const BrainIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 0 0-5.78 1.128 2.25 2.25 0 0 1-2.475 2.118A2.25 2.25 0 0 1 .8 16.518a2.25 2.25 0 0 1 2.22-2.219c.684.065 1.35.346 1.857.743a3.001 3.001 0 0 0 4.659-2.222 2.25 2.25 0 0 1 2.22-2.218 2.25 2.25 0 0 1 2.475 2.118 3 3 0 0 0 5.78 1.128 2.25 2.25 0 0 1 2.475-2.118 2.25 2.25 0 0 1 2.22 2.219c-.684-.065-1.35-.346-1.857-.743a3 3 0 0 0-4.659 2.222 2.25 2.25 0 0 1-2.22 2.218 2.25 2.25 0 0 1-2.475-2.118 3 3 0 0 0-5.78-1.128Z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 18a3 3 0 0 0-3-3m0 0a3 3 0 0 0 3-3m0 0a3 3 0 0 0-3-3m0 0a3 3 0 0 0 3-3m-3 3h6m-6 0a3 3 0 0 1-3-3m0 0a3 3 0 0 1 3-3m0 0a3 3 0 0 1 3-3m0 0a3 3 0 0 1-3-3m3 3h-6m6 0a3 3 0 0 0 3 3m0 0a3 3 0 0 0-3 3m0 0a3 3 0 0 0 3 3m0 0a3 3 0 0 0-3 3m3-3h-6m-3 3a3 3 0 0 1 3-3m0 0a3 3 0 0 1-3-3m0 0a3 3 0 0 1-3-3m0 0a3 3 0 0 1 3-3m-3 3h6m-6 0a3 3 0 0 0-3 3m0 0a3 3 0 0 0 3 3m0 0a3 3 0 0 0-3 3m3-3h6" />
    </svg>
);

export const WandIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.528 1.718a.75.75 0 0 1 .162.819A8.97 8.97 0 0 0 9 6a9 9 0 0 0 9 9 8.97 8.97 0 0 0 3.463-.69a.75.75 0 0 1 .981.981l-3.956 3.957a.75.75 0 0 1-1.06 0l-2.956-2.957a.75.75 0 0 1 0-1.06l1.89-1.89a.75.75 0 0 1 1.061 0l.308.307a.75.75 0 0 0 1.06 0l1.42-1.42a.75.75 0 0 0 0-1.06l-3.11-3.11a.75.75 0 0 0-1.06 0l-.308.307a.75.75 0 0 1-1.06 0l-2.957-2.956a.75.75 0 0 1 0-1.06l3.957-3.956a.75.75 0 0 1 .819.162Z" />
    </svg>
);
...
export const SiloLiveIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="currentColor"
