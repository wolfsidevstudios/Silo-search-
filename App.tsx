...
import type { WebSearchResult, ImageSearchResult, Source, AgentType, ChatMessage, CustomizationSettings } from './types';
...
const App: React.FC = () => {
  ...
  const renderContent = () => {
    switch (view) {
      ...
      case 'silo_live':
        return <SiloLiveView onExit={() => setView('home')} ai={ai} />;
      default:
        return null;
    }
  };
